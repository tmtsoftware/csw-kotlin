...
class KeyTest: DescribeSpec({
    ...
    describe("test booleanKey") {
        ...
        val listOut = listIn.map { it.toString() }
...
*/
    ...
    describe("test short array in IntegerKey") {
        val a1 = shortArrayOf(1, 2, 3, 4, 5)
        val a2 = shortArrayOf(10, 20, 30, 40, 50)

        val a1Out = a1.map { it.toDouble() }.toTypedArray()
