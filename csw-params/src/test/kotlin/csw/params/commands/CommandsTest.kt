...
//        classDiscriminator = "_type"
    ...
    describe("Examples of Prefix") {
        it("should show usage of utility functions") {
            ...
            //validations
            prefix1.subsystem shouldBe Subsystem.NFIRAOS
            prefix2.subsystem shouldBe Subsystem.TCS
            prefix3.subsystem shouldBe Subsystem.WFOS
        }
    }
    ...
    describe("Examples of commands") {
        ...
        it("Should show usage of Setup command") {
            ...
            val k2bad = IntegerKey("missingKey")
            val k3 = IntegerKey.make("filter")
            val k4 = NumberKey("correction")

            //prefix
            val prefix = Prefix("wfos.red.detector")

            //parameters
            val i1: HasKey = k1.set(22)
            ...
            //add binary payload
            val byteKey1 = ByteKey("byteKey1")
            val byteKey2 = ByteKey("byteKey2")
            val bytes1: ByteArray = byteArrayOf(10, 20)
            val bytes2: ByteArray = byteArrayOf(30, 40)
            ...
            //assert(ex)
            paramSize shouldBe 4
            sc3.size shouldBe 2
            sc4.size shouldBe 1
            allKeys.size shouldBe 1
        }
    }
}
)
